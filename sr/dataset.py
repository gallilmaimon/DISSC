...
class CodeDataset(torch.utils.data.Dataset):
    def __init__(self, training_files, segment_size, code_hop_size, n_fft, num_mels,
                 ...
                 f0_interp=False, vqvae=False, id_to_spkr=None, eval_mode=False, unseen_speakers=False):
        ...
        self.unseen_speakers = unseen_speakers
    ...
    def __getitem__(self, index):
        ...
        if self.multispkr:
            if self.unseen_speakers:
                feats['spkr'] = np.array([0])
            else:
